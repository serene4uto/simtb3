...
def generate_launch_description():
    ...
    declare_2d_config_dir = DeclareLaunchArgument(
        ...
        default_value= os.path.join(get_package_share_directory('simtb3_mapping'), 'config'),
    ...
    declare_2d_rviz_config_file = DeclareLaunchArgument(
        name='rviz_config',
        default_value=os.path.join(get_package_share_directory('simtb3_mapping'), 'config', '2d_cartographer.rviz'),
    ...
    node_occupancy_grid_node = Node(
        ...
        # remappings=[('map', 'simtb3/scan_map')]
    )
